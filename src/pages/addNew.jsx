...
import { GetCategory, getColor } from "../Api/api";
...
const AddNewProduct = () => {
   ...
   const dispatch = useDispatch()
    ...
    useEffect(() => {
      ...
      const { category, brands, colors } = useSelector((state) => state.TodoSlicer);
    ...
    <div className="w-[1500px]">
      ...
      <div className="flex flex-wrap gap-10 justify-between items-start w-full max-md:max-w-full">
        <div className="flex flex-wrap gap-2 items-center text-2xl font-bold text-gray-900 min-w-[240px] w-[485px] max-md:max-w-full">
          ...
          />
          <Link to={`/products`} className="self-stretch my-auto">Products</Link>
      ...
      <div className="flex flex-wrap gap-10 items-start mt-6 w-full max-md:max-w-full">
          ...
          <div className="flex flex-col w-full max-md:max-w-full">
            ...
            <div className="flex flex-wrap gap-4 items-start mt-4 w-full text-base text-neutral-500 max-md:max-w-full">
              <div className="flex flex-col flex-1 shrink justify-center basis-0 min-w-[240px] max-md:max-w-full">
                <input type="text" placeholder="Product name" className="overflow-hidden flex-1 shrink gap-3 self-stretch p-4 w-full bg-white rounded border border-solid border-neutral-200 max-md:max-w-full"/>
              </div>
              <div className="flex flex-col justify-center w-32 whitespace-nowrap">
                <input type="text" placeholder="Code" className="overflow-hidden flex-1 shrink gap-3 self-stretch p-4 w-full bg-white rounded border border-solid border-neutral-200" />
              </div>
            </div>
            <div className="flex overflow-hidden flex-col justify-center pt-px pb-1 mt-4 w-full rounded border border-solid border-neutral-200 max-md:pb-24 max-md:max-w-full">
              ...
              <textarea name="" placeholder="Description" className="h-[350px] outline-none p-5" id=""></textarea>
            </div>
          </div>
        ...
        >
            {category.slice(0,6).map((elem)=>{
                return(
                    <MenuItem  key={elem.id} value={elem.id}>{elem.categoryName}</MenuItem>
                )
            })}
        ...
        >
            {brands.slice(0,6).map((elem)=>{
                return(
                    <MenuItem  key={elem.id} value={elem.id}>{elem.brandName}</MenuItem>
                )
            })}
          ...
          <div className="flex flex-col pb-5 mt-10 w-full max-md:max-w-full">
            ...
            <div className="flex flex-wrap gap-4 items-start mt-4 w-full text-base text-neutral-500 max-md:max-w-full">
              <div className="flex flex-col flex-1 shrink justify-center basis-0">
                  <input type="number" placeholder="Price" className="flex overflow-hidden gap-3 items-center p-4 w-full bg-white rounded border border-solid border-neutral-200" />
                 
              </div>
              <div className="flex flex-col flex-1 shrink justify-center basis-0">
                  <input type="number" placeholder="Quantity" className="flex overflow-hidden gap-3 items-center p-4 w-full bg-white rounded border border-solid border-neutral-200" />
                 
              </div>
              <div className="flex flex-col flex-1 shrink justify-center basis-0">
                  <input type="number" placeholder="Count" className="flex overflow-hidden gap-3 items-center p-4 w-full bg-white rounded border border-solid border-neutral-200" />
        ...
        <div className="flex flex-col flex-1 shrink basis-0 min-w-[240px]">
          <div className="flex overflow-hidden flex-col p-5 w-full bg-white rounded border border-solid border-slate-200">
            ...
            <div className="flex gap-3.5 justify-between items-start mt-6 w-full">
              {colors.map((elem)=>{
                return (
                    <div key={elem.id} className={`flex border-[1px] border-blue-300  p-2 shrink-0 w-10 h-10 rounded-full`} style={{background:`${elem.colorName}`}} />
          ...
          <div className="flex overflow-hidden flex-col p-5 mt-7 w-full text-base bg-white rounded border border-solid border-slate-200">
            ...
            <div className="flex gap-2 items-center mt-6 w-full rotate-[-6.938893903907228e-18rad] text-neutral-500">
              <div className="flex flex-col flex-1 shrink justify-center self-stretch my-auto basis-0 min-h-[56px] min-w-[240px] rotate-[6.938893903907228e-18rad]">
                <input type="text" placeholder="Tags name" className="overflow-hidden outline-none flex-1 shrink gap-3 self-stretch p-4 w-full bg-white rounded border border-solid border-neutral-200" />
              </div>
              <img
                loading="lazy"
            ...
            <div className="flex flex-wrap gap-2 items-start mt-6 max-w-full text-sm leading-none text-gray-500 w-[235px]">
              <div className="flex overflow-hidden gap-0.5 items-center pr-1.5 pl-2.5 whitespace-nowrap rounded bg-slate-200">
                <div className="self-stretch my-auto">T-Shirt</div>
                <img
                  loading="lazy"
              ...
              <div className="flex overflow-hidden gap-0.5 items-center pr-1.5 pl-2.5 rounded bg-slate-200">
                <div className="self-stretch my-auto">Men Clothes</div>
                <img
                  loading="lazy"
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/8685fcc41055b44a9037822ae8a4dd4e3c2f43d1eb36c74383ac762f74e0f247?placeholderIfAbsent=true&apiKey=e940a6a49e084455a40af88cc6d38123"
                  className="object-contain shrink-0 self-stretch my-auto w-6 aspect-square"
              ...
              <div className="flex overflow-hidden gap-0.5 items-center pr-1.5 pl-2.5 rounded bg-slate-200">
                <div className="self-stretch my-auto">Summer Collection</div>
                <img
                  loading="lazy"
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/8685fcc41055b44a9037822ae8a4dd4e3c2f43d1eb36c74383ac762f74e0f247?placeholderIfAbsent=true&apiKey=e940a6a49e084455a40af88cc6d38123"
                  className="object-contain shrink-0 self-stretch my-auto w-6 aspect-square"
      ...
      <label className="custum-file-upload">
        <div className="icon">
          <img
            src="https://cdn.builder.io/api/v1/image/assets/TEMP/a0d75007d028389deffbcdaee35a1237bb73f22e658ec79c344115a50ddf640c?placeholderIfAbsent=true&apiKey=e940a6a49e084455a40af88cc6d38123"
            alt=""
          />
        </div>
        <div className="text">
